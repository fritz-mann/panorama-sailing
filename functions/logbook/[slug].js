export async function onRequest(context) {
  ...
  try {
    ...
    // Share URLs
    const shareInstagram = `https://www.instagram.com/sailingpanorama/`;
    ...
    const shareTikTok = `https://www.tiktok.com/@panoramasailing`;
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .share-btn.tiktok:hover { border-color:#ff0050; color:#ff0050; }
...
<div class="post-container">
  ...
  <div class="share-section">
    ...
    <div class="share-buttons">
      <a href="${shareInstagram}" target="_blank" rel="noopener" class="share-btn instagram">
      ...
      <a href="${shareTikTok}" target="_blank" rel="noopener" class="share-btn tiktok">
